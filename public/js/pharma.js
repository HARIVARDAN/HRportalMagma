 ...
 function loadCompetitions(){
    ...
    ref.once('value', function(snapshot1) {
      ...
      if (snapshot1.hasChild('Pharma')){
        
         ref.child('Pharma').once('value', function(snapshot) {
       ...
       {
         $('#modal-text').text("No competitions found");
         $("#modal_alert").modal({backdrop: true});
         $('#no_competition').show();
         $('#no_competition').text("Yet Competitions are not held in this Category");
       }
