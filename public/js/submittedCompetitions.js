function getsubmittedCompetitions(){
...
var i=1;
var ref = firebase.database().ref('User Submissions/' + currentUID + '/');
  ...
  $('#table_div').show();
     var tr;
           tr = $('<tr/>');
            ...
            tr.append("<td><a href='"+m.solution_url+"'>View Solution</a>");

            $('#submittedCompetitions_tbody').append(tr);
        i++;
